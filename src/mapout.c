	...
	{	/* rows */
		...
		{	/* cols (78, i think) */
			...
			if ( x < 79 )
			{
				...
				newy = y;
				newx++;
				while ( newx <= 79 && ( map[y][newx].code == '-' || map[y][newx].code == ':' || map[y][newx].code == '=' || map[y][newx].code == '[' || map[y][newx].code == ']' ) )
					newx++;
				/*
				 * dont link it to itself 
				 */
			...
			if ( x > 1 )
			{
				...
				newy = y;
				newx--;
				while ( newx >= 0 && ( map[y][newx].code == '-' || map[y][newx].code == ':' || map[y][newx].code == '=' || map[y][newx].code == '[' || map[y][newx].code == ']' ) )
					newx--;
				/*
				 * dont link it to itself 
				 */
			...
			if ( y < 48 && x < 79 )
			{
				...
				newx += 2;
				newy++;
				while ( newx <= 79 && newy <= 48 && ( map[newy][newx].code == '\\' || map[newy][newx].code == ':' || map[newy][newx].code == '=' ) )
				{
					newx++;
					newy++;
				}
			...
			if ( y > 1 && x < 79 )
			{
				...
				newx += 2;
				newy--;
				while ( newx >= 0 && newy <= 48 && ( map[newy][newx].code == '/' || map[newy][newx].code == ':' || map[newy][newx].code == '=' ) )
				{
					newx++;
					newy--;
				}
			...
			if ( y > 1 && x > 1 )
			{
				...
				newx -= 2;
				newy--;
				while ( newx >= 0 && newy >= 0 && ( map[newy][newx].code == '\\' || map[newy][newx].code == ':' || map[newy][newx].code == '=' ) )
				{
					newx--;
					newy--;
				}
